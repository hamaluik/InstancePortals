...
@CommandInfo(alias = "pcancel", permission = "portal.create", usage = "", description = "cancels definition of your portal")
public class PortalCancel implements Command {
	private static InstancePortals plugin = null;
	public PortalCancel(InstancePortals instance) {
		plugin = instance;
	}
	...
	public Boolean handle(Player player, String sArgs) {
		...
		plugin.playerManager.cancelPortalDefinition(player);
