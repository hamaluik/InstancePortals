...
@CommandInfo(alias = "pexit", permission = "portal.create", usage = "", description = "defines the exit of your portal")
public class PortalExit implements Command {
	private static InstancePortals plugin = null;
	public PortalExit(InstancePortals instance) {
		plugin = instance;
	}
	...
	public Boolean handle(Player player, String sArgs) {
		...
		plugin.playerManager.definePortalExit(player);
